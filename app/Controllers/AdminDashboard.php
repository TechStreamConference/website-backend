...
class AdminDashboard extends BaseController
{
    ...
    private const EVENT_RULES = [
        ...
        'youtube_channel_url' => 'permit_empty|string|max_length[200]',
        'trailer_url' => 'permit_empty|string|max_length[200]',
        'trailer_poster_url' => 'permit_empty|string|max_length[200]',
        'trailer_subtitles_url' => 'permit_empty|string|max_length[200]',
    ...
    public function createEvent(): ResponseInterface
    {
        ...
        $eventModel->createEvent(
            ...
            youtubeChannelUrl: $validData['youtube_channel_url'] ?? null,
            trailerUrl: $validData['trailer_url'] ?? null,
            trailerPosterUrl: $validData['trailer_poster_url'] ?? null,
            trailerSubtitlesUrl: $validData['trailer_subtitles_url'] ?? null,
